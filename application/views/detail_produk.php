                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 ">
                        <div class="ps-product__thumbnail">
                            ...
                            <div class="ps-product__image">
                                ...
                                <div class="item"><a href="<?= base_url() ?>assets/client/images/products/detail/large-2.jpg"><img src="<?= base_url() ?>assets/client/images/products/detail/large-2.jpg" alt=""></a></div>
                                <div class="item"><a href="<?= base_url() ?>assets/client/images/products/detail/large-3.jpg"><img src="<?= base_url() ?>assets/client/images/products/detail/large-3.jpg" alt=""></a></div>
                                <div class="item"><a href="<?= base_url() ?>assets/client/images/products/detail/large-4.jpg"><img src="<?= base_url() ?>assets/client/images/products/detail/large-4.jpg" alt=""></a></div>
                                <div class="item"><a href="<?= base_url() ?>assets/client/images/products/detail/large-5.jpg"><img src="<?= base_url() ?>assets/client/images/products/detail/large-5.jpg" alt=""></a></div>
                            </div>
                            <div class="ps-product__preview">
                                <div class="ps-product__variants">
                                    <div class="item"><img src="<?= base_url() ?>uploads/gambar_produk/<?= $prd['gambar'] ?>" alt=""></div>
                                    <div class="item"><img src="<?= base_url() ?>assets/client/images/products/detail/variant-2.png" alt=""></div>
                                    <div class="item"><img src="<?= base_url() ?>assets/client/images/products/detail/variant-3.png" alt=""></div>
                                    <div class="item"><img src="<?= base_url() ?>assets/client/images/products/detail/variant-4.png" alt=""></div>
                                    <div class="item">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 ">
                        <div class="ps-product__info">
                            ...
                            <div class="ps-product__shopping">
                                <form class="ps-form--shopping" id="cart" action="do_action" method="post">
                            ...
                            <div class="ps-product__shopping">
                                <?php if ($prd['stok'] > 0) : ?>
                                    <button class="add_cart ps-btn ps-btn--yellow" data-produkid="<?= $prd['idProduk'] ?>" data-produknama="<?= $prd['namaProduk'] ?>" data-produkharga="<?= $prd['harga'] ?>" data-produkgambar="<?= $prd['gambar'] ?>">Masukkan Keranjang</button>
                                <?php else : ?>

                    ...
                    <?php foreach ($produk as $prd) : ?>
                        <div class="col-lg-4">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><img src="<?= base_url() ?>uploads/gambar_produk/<?= $prd['gambar'] ?>" alt=""><a class="ps-product__overlay" href="product-detail.html"></a>
                                ...
                                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.html"><?= $prd['namaProduk'] ?></a>

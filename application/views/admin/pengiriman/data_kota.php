                                    ...
                                    foreach ($kota as $kot) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger ml-5" data-toggle="modal" data-target="#modal_hapus_kota<?php echo $kot['id_daerah'] ?>"><i class="fas fa-trash"></i> Hapus</button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
